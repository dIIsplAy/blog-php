...
echo'
    ...
    <form id="log"method="POST" name="blog" action="../exo-register/auth.php">
        <input type="log" name="login" placeholder="Pseudonyme" />
        <input type="password" name="pass" placeholder="Password" />
        <!--<button>SEND</button>-->
        <input type="submit" value="LOGIN" />
    </form>
    <form id="register"method="POST" name="register" action="../exo-register/register.php">
     <input type="submit" value="REGISTER" />
     </form>
';
    }else {
        echo 'WESHHH !'.' '.$_SESSION['login'].' ';
        echo '<form action="../exo-register/logout.php" method="POST"><button>se déconnecter</button></form>';
    }
  ?>       
</body>
</html>